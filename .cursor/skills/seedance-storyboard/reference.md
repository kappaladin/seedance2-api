...
**media_files 顺序规则**：prompt 中 `@图片1` 对应 media_files 数组第 1 个 URL，`@图片2` 对应第 2 个，以此类推。视频和音频也按出现顺序排列。
...
5. **匹配视频比例**：image_size 与目标视频的 aspect_ratio 保持一致
